...
fun whereClauseSource(itemsSource: Source): Source = itemsSource.ifNotEmpty {
  spaceSeparated(WHERE_KEYWORD, it)
}
...
private fun typeParameterVarianceSource(typeVariable: TypeVariable): Source =
  typeVariable.j2ktVariance?.source.orEmpty()

private val J2ktVariance.source: Source
  get() =
    when (this) {
      J2ktVariance.IN -> IN_KEYWORD
      J2ktVariance.OUT -> OUT_KEYWORD
    }

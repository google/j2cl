...
public class WasmModuleGenerator {
  ...
  private void emitGlobals(List<CompilationUnit> compilationUnits) {
    emitVtableGlobals(compilationUnits);
    emitStaticFieldGlobals(compilationUnits);
  }
  ...
  private void emitStaticFieldGlobals(List<CompilationUnit> compilationUnits) {
    compilationUnits.stream()
        .flatMap(c -> c.getTypes().stream())
  ...
  private void emitVtableGlobals(List<CompilationUnit> compilationUnits) {
    compilationUnits.stream()
        .flatMap(c -> c.getTypes().stream())

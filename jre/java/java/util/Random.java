...
/**
 * This class provides methods that generates pseudo-random numbers of different types, such as
 * {@code int}, {@code long}, {@code double}, and {@code float}. It follows the algorithms specified
 * in the JRE javadoc.
 *
 * <p>This emulated version of Random is not serializable.
 */
public class Random {
  ...
  /**
   * Construct a random generator with the current time of day in milliseconds plus a unique counter
   * value as the initial state.
   *
   * @see #setSeed
   */
  public Random() {
  ...
  /**
   * Generates a uniformly distributed 32-bit {@code int} value from the random number sequence.
   *
  ...
  /**
   * Modifies the seed a using linear congruential formula presented in <i>The Art of Computer
   * Programming, Volume 2</i>, Section 3.2.1.
   *

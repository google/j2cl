...
transpiler_bin="blaze-bin/third_party/java_src/j2cl/internal_do_not_use/J2clTranspiler"
...
blaze build third_party/java_src/j2cl/internal_do_not_use:J2clTranspiler

 ...
 */
public class DevirtualizeMethodCalls extends AbstractRewriter {

  public static void applyTo(CompilationUnit compilationUnit) {
    compilationUnit.accept(new DevirtualizeMethodCalls());
  }
  ...
  private MethodCall devirtualizeRegularMethodCall(MethodCall methodCall) {
    ...
    if (MethodDescriptors.isToStringMethodDescriptor(methodCall.getTarget())) {
      ...
      return AstUtils.createDevirtualizedMethodCall(
          methodCall, BootstrapType.OBJECTS.getDescriptor(), TypeDescriptors.get().javaLangObject);
    }

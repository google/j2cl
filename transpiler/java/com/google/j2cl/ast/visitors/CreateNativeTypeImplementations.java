 ...
 */
public class CreateNativeTypeImplementations extends AbstractRewriter {

  public static void applyTo(CompilationUnit compilationUnit) {
    compilationUnit.accept(new CreateNativeTypeImplementations());
  }
  ...
  public Node rewriteMethod(Method method) {
    ...
    // Replace the enclosingClassTypeDescriptor.
    return Method.Builder.from(method).enclosingClass(jsOverlayImplTypeDescriptor).build();
  }

 ...
 */
public class InsertNarrowingReferenceConversionVisitor extends ConversionContextVisitor {

  public static void applyTo(CompilationUnit compilationUnit) {
    new InsertNarrowingReferenceConversionVisitor().run(compilationUnit);
  }

  public InsertNarrowingReferenceConversionVisitor() {
    super(
        new ContextRewriter() {
          @Override

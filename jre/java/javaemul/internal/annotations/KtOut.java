 ...
 *
 * <p>The transpiler will also remove redundant {@code out} modifier from wildcards corresponding to
 * the annotated type parameter, so {@code Iterable<T>} will be converted to {@code Iterable<T>}.
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE_PARAMETER)
@Documented
public @interface KtOut {}

...
//     }
    ...
    // ADDED FOR J2CL
    // JUnit3 has a setUp/tearDown method, but it is protected
    // We need to be able to call these methods from JavaScript, so we expose them this way.
    // J2clTestingProcessingStep.java depends on these methods being present
    public void __hiddenSetUp() throws Exception {
      setUp();
    }
    ...
    // We need to be able to call these methods from JavaScript, so we expose them this way.
    // J2clTestingProcessingStep.java depends on these methods being present
    public void __hiddenTearDown() throws Exception {
      tearDown();
    }
}

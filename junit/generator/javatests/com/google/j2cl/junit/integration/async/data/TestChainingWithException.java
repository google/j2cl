...
public class TestChainingWithException {
  @Test(timeout = 200L)
  public Thenable testChainingWithException() {
    return (onFulfilled, onRejected) ->
        Timer.schedule(
            () -> onRejected.execute(new RuntimeException("Should fail with this message")), 0);
  }
}

...
public interface ParameterizedType<F, T>
    extends overwrittentypevariables.otherpkg.ParameterizedType<F, T> {
  @Override
  T accept(F value);
}

class ParameterizedTypeImpl implements ParameterizedType<String, Integer> {
  @Override
  public Integer accept(String value) {
    return 1;
  }
}

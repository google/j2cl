...
public class NullabilityInferenceProblem16 {
  ...
  // TODO(b/450979894): Enable when fixed.
  ...
  // Workaround
  public static void workaround(ImmutableList<Holder<@Nullable Void>> holders) {
    wrap(holders).check((ImmutableList<Holder<@Nullable Void>> list) -> true);
  }
}

...
/**
 * This class represents immutable arbitrary precision decimal numbers. Each {@code BigDecimal}
 * instance is represented with a unscaled arbitrary precision mantissa (the unscaled value) and a
 * scale. The value of the {@code BigDecimal} is {@code unscaledValue} 10^(-{@code scale}).
 */
public class BigDecimal extends Number implements Comparable<BigDecimal>, Serializable {
   ...
   * behaves as {@link #ROUND_UP}, for negative values as {@link #ROUND_DOWN}.
   *
   ...
   * behaves as {@link #ROUND_DOWN}, for negative values as {@link #ROUND_UP}.
   *
  ...
  /**
   * Rounding mode where the rounding operations throws an {@code ArithmeticException} for the case
  ...
  /**
   * Returns a new {@code BigDecimal} instance whose value is equal to {@code val}. The new decimal
   * is constructed as if the {@code BigDecimal(String)} constructor is called with an argument
   * which is equal to {@code Double.toString(val)}. For example, {@code valueOf("0.1")} is
   * converted to (unscaled=1, scale=1), although the double {@code 0.1} cannot be represented
   * exactly as a double value. In contrast to that, a new {@code BigDecimal(0.1)} instance has the
   * value {@code 0.1000000000000000055511151231257827021181583404541015625} with an unscaled value
   * {@code 1000000000000000055511151231257827021181583404541015625} and the scale {@code 55}.
   *
  ...
  /**
   * Returns a new {@code BigDecimal} instance whose value is equal to {@code unscaledVal}. The
   * scale of the result is {@code 0}, and its unscaled value is {@code unscaledVal}.
   *
  ...
  /**
   * Returns a new {@code BigDecimal} instance whose value is equal to {@code unscaledVal}
   * 10^(-{@code scale}). The scale of the result is {@code scale}, and its unscaled value is {@code
   * unscaledVal}.
   *
   * @param unscaledVal unscaled value to be used to construct the new {@code BigDecimal}.
   * @param scale scale to be used to construct the new {@code BigDecimal}.
   * @return {@code BigDecimal} instance with the value {@code unscaledVal}* 10^(-{@code
   *     unscaledVal}).
   */
  ...
  private static BigDecimal addAndMult10(
      BigDecimal thisValue, BigDecimal augend, double diffScale) {
    if (diffScale < DOUBLE_TEN_POW.length
        && Math.max(
                    thisValue.bitLength,
                    augend.bitLength + DOUBLE_TEN_POW_BIT_LENGTH[(int) diffScale])
                + 1
            < SMALL_VALUE_BITS) {
      return valueOf(
          thisValue.smallValue + augend.smallValue * DOUBLE_TEN_POW[(int) diffScale],
          thisValue.scale);
    }
    return new BigDecimal(
        thisValue
            .getUnscaledValue()
            .add(Multiplication.multiplyByTenPow(augend.getUnscaledValue(), (int) diffScale)),
        thisValue.scale);
  }
  ...
  private static BigDecimal divideBigIntegers(
      BigInteger scaledDividend, BigInteger scaledDivisor, int scale, RoundingMode roundingMode) {
  ...
  private static BigDecimal dividePrimitiveDoubles(
      double scaledDividend, double scaledDivisor, int scale, RoundingMode roundingMode) {
  ...
  /**
   * It tests if a scale of type {@code long} fits in 32 bits. It returns the same scale being
   * casted to {@code int} type when is possible, otherwise throws an exception.
   *
   * @param doubleScale a double bit scale
   * @return a 32 bit scale when is possible
   * @throws ArithmeticException when {@code scale} doesn't fit in {@code int} type
   * @see #scale
   */
  ...
  /**
   * It returns the value 0 with the most approximated scale of type {@code int} . if {@code
   * longScale > Integer.MAX_VALUE} the scale will be {@code Integer.MAX_VALUE}; if {@code longScale
   * < Integer.MIN_VALUE} the scale will be {@code Integer.MIN_VALUE}; otherwise {@code longScale}
   * is casted to the type {@code int}.
   *
   ...
   * of the result is {@code 0}.
   *
   * @param val {@code BigInteger} value to be converted to a {@code BigDecimal} instance.
   */
  ...
  /**
   * Constructs a new {@code BigDecimal} instance from a given unscaled value {@code unscaledVal}
   * and a given scale. The value of this instance is {@code unscaledVal} 10^(-{@code scale}).
   *
   * @param unscaledVal {@code BigInteger} representing the unscaled value of this {@code
   *     BigDecimal} instance.
  ...
  /**
   * Constructs a new {@code BigDecimal} instance from a given unscaled value {@code unscaledVal}
   * and a given scale. The value of this instance is {@code unscaledVal} 10^(-{@code scale}). The
   * result is rounded according to the specified math context.
   *
   * @param unscaledVal {@code BigInteger} representing the unscaled value of this {@code
   *     BigDecimal} instance.
   * @param scale scale of this {@code BigDecimal} instance.
   ...
   *     UNNECESSARY} and the new big decimal cannot be represented within the given precision
   *     without rounding.
   * @throws NullPointerException if {@code unscaledVal == null}.
   */
   ...
   * array.
   *
   * @param in array of characters containing the string representation of this {@code BigDecimal}.
   * @throws NullPointerException if {@code in == null}.
   * @throws NumberFormatException if {@code in} does not contain a valid string representation of a
   *     big decimal.
   */
   ...
   * @throws NullPointerException if {@code in == null}.
   * @throws NumberFormatException if {@code offset < 0} or {@code len <= 0} or {@code offset+len-1
   *     < 0} or {@code offset+len-1 >= in.length}.
  ...
  /**
   * Constructs a new {@code BigDecimal} instance from a string representation given as a character
   * array. The result is rounded according to the specified math context.
   *
   * @param in array of characters containing the string representation of this {@code BigDecimal}.
   * @param mc rounding mode and precision for the result of this operation.
   * @throws NullPointerException if {@code in == null}.
  ...
  /**
   * Constructs a new {@code BigDecimal} instance from the given double {@code val}. The scale of
   * the result is 0.
   *
  ...
  /**
   * Constructs a new {@code BigDecimal} instance from the given double {@code val}. The scale of
   * the result is 0. The result is rounded according to the specified math context.
   *
   * @param val double value to be converted to a {@code BigDecimal} instance.
   * @param mc rounding mode and precision for the result of this operation.
   * @throws NumberFormatException if {@code val} is infinite or a NaN
  ...
  /**
   * Constructs a new {@code BigDecimal} instance from the given int {@code val} . The scale of the
   * result is 0.
   *
  ...
  /**
   * Constructs a new {@code BigDecimal} instance from the given int {@code val} . The scale of the
   * result is {@code 0}. The result is rounded according to the specified math context.
   *
   * @param val int value to be converted to a {@code BigDecimal} instance.
   * @param mc rounding mode and precision for the result of this operation.
  ...
  /**
   * Constructs a new {@code BigDecimal} instance from the given long {@code val}. The scale of the
   * result is {@code 0}.
   *
   ...
   *
   * @param val string containing the string representation of this {@code BigDecimal}.
   * @throws NumberFormatException if {@code val} does not contain a valid string representation of
   *     a big decimal.
   */
  ...
  /**
   * Constructs a new {@code BigDecimal} instance from a string representation. The result is
   * rounded according to the specified math context.
   *
   * @param val string containing the string representation of this {@code BigDecimal}.
   * @param mc rounding mode and precision for the result of this operation.
   * @throws NumberFormatException if {@code val} does not contain a valid string representation of
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is the absolute value of {@code this}. The scale
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is the absolute value of {@code this}. The result
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this + augend}. The scale of the result
   * is the maximum of the scales of the two arguments.
   *
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this + augend}. The result is rounded
  ...
  public BigDecimal add(BigDecimal augend, MathContext mc) {
    ...
    if (largerSignum == smaller.signum()) {
      ...
      tempBI =
          Multiplication.multiplyByPositiveInt(tempBI, 10)
  ...
  /**
   * Returns this {@code BigDecimal} as a byte value if it has no fractional part and if its value
   * fits to the byte range ([-128..127]). If these conditions are not met, an {@code
  ...
  /**
   * Compares this {@code BigDecimal} with {@code val}. Returns one of the three values {@code 1},
   * {@code 0}, or {@code -1}. The method behaves as if {@code this.subtract(val)} is computed. If
   * this difference is > 0 then 1 is returned, if the difference is < 0 then -1 is returned, and if
   * the difference is 0 then 0 is returned. This means, that if two decimal instances are compared
   * which are equal in value but differ in scale, then these two instances are considered as equal.
   *
  ...
  public int compareTo(BigDecimal val) {
    ...
    if (thisSign == valueSign) {
      if (this.scale == val.scale
          && this.bitLength < SMALL_VALUE_BITS
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this / divisor}. The scale of the result
   * is the difference of the scales of {@code this} and {@code divisor}. If the exact result
   * requires more digits, then the scale is adjusted accordingly. For example, {@code 1/128 =
   * 0.0078125} which has a scale of {@code 7} and precision {@code 5}.
   *
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this / divisor}. The scale of the result
   * is the scale of {@code this}. If rounding is required to meet the specified scale, then the
   * specified rounding mode {@code roundingMode} is applied.
   *
   * @param divisor value by which {@code this} is divided.
   * @param roundingMode rounding mode to be used to round the result.
   * @return {@code this / divisor} rounded according to the given rounding mode.
   * @throws NullPointerException if {@code divisor == null}.
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this / divisor}. As scale of the result
   * the parameter {@code scale} is used. If rounding is required to meet the specified scale, then
   * the specified rounding mode {@code roundingMode} is applied.
   *
   * @param divisor value by which {@code this} is divided.
   ...
   * @throws ArithmeticException if {@code divisor == 0}.
   * @throws ArithmeticException if {@code roundingMode == RoundingMode.UNNECESSAR}Y and rounding is
  ...
  public BigDecimal divide(BigDecimal divisor, int scale, RoundingMode roundingMode) {
    ...
    if (this.bitLength < SMALL_VALUE_BITS && divisor.bitLength < SMALL_VALUE_BITS) {
      if (diffScale == 0) {
        ...
        if (diffScale < DOUBLE_TEN_POW.length
            && divisor.bitLength + DOUBLE_TEN_POW_BIT_LENGTH[(int) diffScale] < SMALL_VALUE_BITS) {
          return dividePrimitiveDoubles(
              this.smallValue,
        ...
        if (-diffScale < DOUBLE_TEN_POW.length
            && this.bitLength + DOUBLE_TEN_POW_BIT_LENGTH[(int) -diffScale] < SMALL_VALUE_BITS) {
          return dividePrimitiveDoubles(
              this.smallValue * DOUBLE_TEN_POW[(int) -diffScale],
              divisor.smallValue,
              scale,
              roundingMode);
        }
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this / divisor}. The result is rounded
   * according to the passed context {@code mc}. If the passed math context specifies precision
   * {@code 0}, then this call is equivalent to {@code this.divide(divisor)}.
   *
   * @param divisor value by which {@code this} is divided.
   * @param mc rounding mode and precision for the result of this operation.
   * @return {@code this / divisor}.
   ...
   * @throws ArithmeticException if {@code divisor == 0}.
   * @throws ArithmeticException if {@code mc.getRoundingMode() == UNNECESSARY} and rounding is
   *     necessary according {@code mc.getPrecision()}.
   */
   ...
   * @throws NullPointerException if {@code divisor == null} or {@code roundingMode == null}.
   * @throws ArithmeticException if {@code divisor == 0}.
   * @throws ArithmeticException if {@code roundingMode == RoundingMode.UNNECESSARY} and rounding is
   *     necessary according to the scale of this.
   */
   ...
   * at index 0 and the remainder {@code this % divisor} at index 1. The quotient is rounded down
   * towards zero to the next integer.
   *
   * @param divisor value by which {@code this} is divided.
   ...
   * Returns a {@code BigDecimal} array which contains the integral part of {@code this / divisor}
   * at index 0 and the remainder {@code this % divisor} at index 1. The quotient is rounded down
   * towards zero to the next integer. The rounding mode passed with the parameter {@code mc} is not
   * considered. But if the precision of {@code mc > 0} and the integral part requires more digits,
   * then an {@code ArithmeticException} is thrown.
   *
   * @param divisor value by which {@code this} is divided.
   * @param mc math context which determines the maximal precision of the result.
   * @return {@code [this.divideToIntegralValue(divisor), this.remainder(divisor)]}.
   * @throws NullPointerException if {@code divisor == null}.
   * @throws ArithmeticException if {@code divisor == 0}.
   * @see #divideToIntegralValue
   ...
   * The quotient is rounded down towards zero to the next integer. For example, {@code 0.5/0.2 =
   * 2}.
   *
   * @param divisor value by which {@code this} is divided.
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is the integral part of {@code this / divisor}.
   * The quotient is rounded down towards zero to the next integer. The rounding mode passed with
   * the parameter {@code mc} is not considered. But if the precision of {@code mc > 0} and the
   * integral part requires more digits, then an {@code ArithmeticException} is thrown.
   *
   * @param divisor value by which {@code this} is divided.
   * @param mc math context which determines the maximal precision of the result.
   * @return integral part of {@code this / divisor}.
  ...
  /**
   * Returns this {@code BigDecimal} as a double value. If {@code this} is too big to be represented
   * as an float, then {@code Double.POSITIVE_INFINITY} or {@code Double.NEGATIVE_INFINITY} is
   * returned.
   *
   * <p>Note, that if the unscaled value has more than 53 significant digits, then this decimal
   * cannot be represented exactly in a double variable. In this case the result is rounded.
   *
   * <p>For example, if the instance {@code x1 = new BigDecimal("0.1")} cannot be represented
   * exactly as a double, and thus {@code x1.equals(new BigDecimal(x1.doubleValue())} returns {@code
   * false} for this case.
   *
   * <p>Similarly, if the instance {@code new BigDecimal(9007199254740993L)} is converted to a
   * double, the result is {@code 9.007199254740992E15}.
   *
   * <p>
   *
  ...
  /**
   * Returns this {@code BigDecimal} as a float value. If {@code this} is too big to be represented
   * as an float, then {@code Float.POSITIVE_INFINITY} or {@code Float.NEGATIVE_INFINITY} is
   * returned.
   *
   * <p>Note, that if the unscaled value has more than 24 significant digits, then this decimal
   * cannot be represented exactly in a float variable. In this case the result is rounded.
   *
   * <p>For example, if the instance {@code x1 = new BigDecimal("0.1")} cannot be represented
   * exactly as a float, and thus {@code x1.equals(new BigDecimal(x1.folatValue())} returns {@code
   * false} for this case.
   *
   * <p>Similarly, if the instance {@code new BigDecimal(16777217)} is converted to a float, the
   * result is {@code 1.6777216E}7.
   *
  ...
  /**
   * Returns this {@code BigDecimal} as an int value. Any fractional part is discarded. If the
   * integral part of {@code this} is too big to be represented as an int, then {@code this} % 2^32
   * is returned.
   *
  ...
  /**
   * Returns this {@code BigDecimal} as a int value if it has no fractional part and if its value
   * fits to the int range ([-2^{31}..2^{31}-1]). If these conditions are not met, an {@code
   * ArithmeticException} is thrown.
   *
   * @return this {@code BigDecimal} as a int value.
  ...
  /**
   * Returns this {@code BigDecimal} as an long value. Any fractional part is discarded. If the
   * integral part of {@code this} is too big to be represented as an long, then {@code this} % 2^64
   * is returned.
   *
  ...
  /**
   * Returns this {@code BigDecimal} as a long value if it has no fractional part and if its value
   * fits to the int range ([-2^{63}..2^{63}-1]). If these conditions are not met, an {@code
   * ArithmeticException} is thrown.
   *
   * @return this {@code BigDecimal} as a long value.
  ...
  /**
   * Returns a new {@code BigDecimal} instance where the decimal point has been moved {@code n}
   * places to the left. If {@code n < 0} then the decimal point is moved {@code -n} places to the
   * right.
   *
   * <p>The result is obtained by changing its scale. If the scale of the result becomes negative,
   * then its precision is increased such that the scale is zero.
   *
   * <p>Note, that {@code movePointLeft(0)} returns a result which is mathematically equivalent, but
   * which has {@code scale >= 0}.
   *
  ...
  /**
   * Returns a new {@code BigDecimal} instance where the decimal point has been moved {@code n}
   * places to the right. If {@code n < 0} then the decimal point is moved {@code -n} places to the
   * left.
   *
   * <p>The result is obtained by changing its scale. If the scale of the result becomes negative,
   * then its precision is increased such that the scale is zero.
   *
   * <p>Note, that {@code movePointRight(0)} returns a result which is mathematically equivalent,
   * but which has scale >= 0.
   *
   * @param n number of placed the decimal point has to be moved.
   * @return {@code this * 10^n}.
   */
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this * multiplicand} . The scale of the
   * result is the sum of the scales of the two arguments.
   *
  ...
  public BigDecimal multiply(BigDecimal multiplicand) {
    ...
    return new BigDecimal(
        this.getUnscaledValue().multiply(multiplicand.getUnscaledValue()), toIntScale(newScale));
  }

  /**
   * Returns a new {@code BigDecimal} whose value is {@code this * multiplicand} . The result is
   * rounded according to the passed context {@code mc}.
   *
   * @param multiplicand value to be multiplied with {@code this}.
   * @param mc rounding mode and precision for the result of this operation.
   * @return {@code this * multiplicand}.
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is the {@code -this}. The scale of the result is
   * the same as the scale of this.
   *
   * @return {@code -this}
   */
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is the {@code -this}. The result is rounded
   * according to the passed context {@code mc}.
   *
   * @param mc rounding mode and precision for the result of this operation.
   * @return {@code -this}
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code +this}. The scale of the result is the
   * same as the scale of this.
   *
   * @return {@code this}
   */
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code +this}. The result is rounded according
   * to the passed context {@code mc}.
   *
   * @param mc rounding mode and precision for the result of this operation.
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this ^ n}. The scale of the result is
   * {@code n} times the scales of {@code this}.
   *
   * <p>{@code x.pow(0)} returns {@code 1}, even if {@code x == 0}.
   *
   * <p>Implementation Note: The implementation is based on the ANSI standard X3.274-1996 algorithm.
   *
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this ^ n}. The result is rounded
   * according to the passed context {@code mc}.
   *
   * <p>Implementation Note: The implementation is based on the ANSI standard X3.274-1996 algorithm.
   *
  ...
  /**
   * Returns the precision of this {@code BigDecimal}. The precision is the number of decimal digits
   * used to represent this decimal. It is equivalent to the number of digits of the unscaled value.
   * The precision of {@code 0} is {@code 1} (independent of the scale).
   *
   ...
   *
   * <p>The remainder is defined as {@code this - this.divideToIntegralValue(divisor) * divisor}.
   *
   * @param divisor value by which {@code this} is divided.
   * @return {@code this % divisor}.
   * @throws NullPointerException if {@code divisor == null}.
   ...
   * <p>The remainder is defined as {@code this - this.divideToIntegralValue(divisor) * divisor}.
   *
   * <p>The specified rounding mode {@code mc} is used for the division only.
   *
   * @param divisor value by which {@code this} is divided.
   ...
   *     this.divideToIntegralValue(divisor, mc)} requires more digits to be represented.
   */
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this}, rounded according to the passed
   * context {@code mc}.
   *
   * <p>If {@code mc.precision = 0}, then no rounding is performed.
   *
   * <p>If {@code mc.precision > 0} and {@code mc.roundingMode == UNNECESSARY}, then an {@code
   * ArithmeticException} is thrown if the result cannot be represented exactly within the given
   * precision.
   *
   * @param mc rounding mode and precision for the result of this operation.
   * @return {@code this} rounded according to the passed context.
   * @throws ArithmeticException if {@code mc.precision > 0} and {@code mc.roundingMode ==
   *     UNNECESSARY} and this cannot be represented within the given precision.
   */
  ...
  /**
   * Returns the scale of this {@code BigDecimal}. The scale is the number of digits behind the
   * decimal point. The value of this {@code BigDecimal} is the unsignedValue * 10^(-scale). If the
   * scale is negative, then this {@code BigDecimal} represents a big integer.
   *
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this} 10^{@code n}. The scale of the
   * result is {@code this.scale()} - {@code n}. The precision of the result is the precision of
   * {@code this}.
   *
   * <p>This method has the same effect as {@link #movePointRight}, except that the precision is not
   * changed.
   *
  ...
  /**
   * Returns a new {@code BigDecimal} instance with the specified scale. If the new scale is greater
   * than the old scale, then additional zeros are added to the unscaled value. If the new scale is
   * smaller than the old scale, then trailing zeros are removed. If the trailing digits are not
   * zeros then an ArithmeticException is thrown.
   *
   * <p>If no exception is thrown, then the following equation holds: {@code
   ...
   *
   * <p>If the new scale is greater than the old scale, then additional zeros are added to the
   * unscaled value. In this case no rounding is necessary.
   *
   * <p>If the new scale is smaller than the old scale, then trailing digits are removed. If these
   * trailing digits are not zero, then the remaining unscaled value has to be rounded. For this
   * rounding operation the specified rounding mode is used.
   *
   * @param newScale scale of the result returned.
   * @param roundingMode rounding mode to be used to round the result.
   * @return a new {@code BigDecimal} instance with the specified scale.
  ...
  public BigDecimal setScale(int newScale, RoundingMode roundingMode) {
    ...
    if (diffScale > 0) {
      ...
      return new BigDecimal(
          Multiplication.multiplyByTenPow(getUnscaledValue(), (int) diffScale), newScale);
    }
    // diffScale < 0
    // return [u,s] / [1,newScale] with the appropriate scale and rounding
    if (this.bitLength < SMALL_VALUE_BITS && -diffScale < DOUBLE_TEN_POW.length) {
      return dividePrimitiveDoubles(
          this.smallValue, DOUBLE_TEN_POW[(int) -diffScale], newScale, roundingMode);
    }
    return divideBigIntegers(
        this.getUnscaledValue(), Multiplication.powerOf10(-diffScale), newScale, roundingMode);
  }

  /**
   * Returns this {@code BigDecimal} as a short value if it has no fractional part and if its value
   * fits to the short range ([-2^{15}..2^{15}-1]). If these conditions are not met, an {@code
   * ArithmeticException} is thrown.
   *
   * @return this {@code BigDecimal} as a short value.
   * @throws ArithmeticException if rounding is necessary of the number doesn't fit in a short.
   */
   ...
   *
   * @return {@code -1} if {@code this < 0}, {@code 0} if {@code this == 0}, {@code 1} if {@code
   *     this > 0}.
   */
  public int signum() {
    if (bitLength < SMALL_VALUE_BITS) {
  ...
  /**
   * Returns a new {@code BigDecimal} instance with the same value as {@code this} but with a
   * unscaled value where the trailing zeros have been removed. If the unscaled value of {@code
   * this} has n trailing zeros, then the scale and the precision of the result has been reduced by
   * n.
   *
   * @return a new {@code BigDecimal} instance equivalent to this where the trailing zeros of the
   *     unscaled value have been removed.
   */
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this - subtrahend}. The scale of the
   * result is the maximum of the scales of the two arguments.
   *
  ...
  public BigDecimal subtract(BigDecimal subtrahend) {
    ...
    if (diffScale == 0) {
      ...
      return new BigDecimal(
          this.getUnscaledValue().subtract(subtrahend.getUnscaledValue()), this.scale);
    } else if (diffScale > 0) {
      // case s1 > s2 : [ u1 - u2 * 10 ^ (s1 - s2) , s1 ]
      if (diffScale < DOUBLE_TEN_POW.length
          && Math.max(
                      this.bitLength,
                      subtrahend.bitLength + DOUBLE_TEN_POW_BIT_LENGTH[(int) diffScale])
                  + 1
              < SMALL_VALUE_BITS) {
        return valueOf(
            this.smallValue - subtrahend.smallValue * DOUBLE_TEN_POW[(int) diffScale], this.scale);
      }
      return new BigDecimal(
          this.getUnscaledValue()
              .subtract(
                  Multiplication.multiplyByTenPow(subtrahend.getUnscaledValue(), (int) diffScale)),
          this.scale);
    } else {
      ...
      if (diffScale < DOUBLE_TEN_POW.length
          && Math.max(
              ...
              < SMALL_VALUE_BITS) {
        return valueOf(
            this.smallValue * DOUBLE_TEN_POW[(int) diffScale] - subtrahend.smallValue,
            subtrahend.scale);
      }
      return new BigDecimal(
  ...
  /**
   * Returns a new {@code BigDecimal} whose value is {@code this - subtrahend}. The result is
   * rounded according to the passed context {@code mc}.
   *
   * @param subtrahend value to be subtracted from {@code this}.
   * @param mc rounding mode and precision for the result of this operation.
  ...
  /**
   * Returns this {@code BigDecimal} as a big integer instance if it has no fractional part. If this
   * {@code BigDecimal} has a fractional part, i.e. if rounding would be necessary, an {@code
   * ArithmeticException} is thrown.
   *
  ...
  /**
   * Returns a string representation of this {@code BigDecimal}. This representation always prints
   * all significant digits of this value.
   *
   * <p>If the scale is negative or if {@code scale - precision >= 6} then engineering notation is
   * used. Engineering notation is similar to the scientific notation except that the exponent is
   * made to be a multiple of 3 such that the integer part is >= 1 and < 1000.
   *
   * @return a string representation of {@code this} in engineering notation if necessary.
   */
  ...
  /**
   * Returns a string representation of this {@code BigDecimal}. No scientific notation is used.
   * This methods adds zeros where necessary.
   *
   * <p>If this string representation is used to create a new instance, this instance is generally
   * not identical to {@code this} as the precision changes.
   *
   * <p>{@code x.equals(new BigDecimal(x.toPlainString())} usually returns {@code false}.
   *
   * <p>{@code x.compareTo(new BigDecimal(x.toPlainString())} returns {@code 0}.
   *
  ...
  /**
   * Returns a canonical string representation of this {@code BigDecimal}. If necessary, scientific
   * notation is used. This representation always prints all significant digits of this value.
   *
   * <p>If the scale is negative or if {@code scale - precision >= 6} then scientific notation is
   * used.
   *
   * @return a string representation of {@code this} in scientific notation if necessary.
   */
  @Override
  ...
  /**
   * Returns the unit in the last place (ULP) of this {@code BigDecimal} instance. An ULP is the
   * distance to the nearest big decimal with the same precision.
   *
   * <p>The amount of a rounding error in the evaluation of a floating-point operation is often
   * expressed in ULPs. An error of 1 ULP is often seen as a tolerable error.
   *
   * <p>For class {@code BigDecimal}, the ULP of a number is simply 10^(-scale).
   *
   * <p>For example, {@code new BigDecimal(0.1).ulp()} returns {@code 1E-55}.
   *
  ...
  /**
   * Returns the unscaled value (mantissa) of this {@code BigDecimal} instance as a {@code
   * BigInteger}. The unscaled value can be computed as {@code this} 10^(scale).
   *
  ...
  /**
   * If the precision already was calculated it returns that value, otherwise it calculates a very
   * good approximation efficiently . Note that this value will be {@code precision()} or {@code
   * precision()-1} in the worst case.
   *
   * @return an approximation of {@code precision()} value
   */
  private double approxPrecision() {
    return (precision > 0) ? precision : Math.floor((this.bitLength - 1) * LOG10_2) + 1;
  }
  ...
  /**
   * It does all rounding work of the public method {@code round(MathContext)}, performing an
   * inplace rounding without creating a new object.
   *
  ...
  private BigDecimal movePoint(double newScale) {
    ...
    if (-newScale < DOUBLE_TEN_POW.length
        && bitLength + DOUBLE_TEN_POW_BIT_LENGTH[(int) -newScale] < SMALL_VALUE_BITS) {
  ...
  /**
   * This method implements an efficient rounding for numbers which unscaled value fits in the type
   * {@code long}.
   *
  ...
  private void smallRound(MathContext mc, int discardedPrecision) {
    ...
    if (fraction != 0) {
      ...
      integer +=
          roundingBehavior(
              ((int) integer) & 1, Long.signum(fraction) * (5 + compRem), mc.getRoundingMode());
      // If after to add the increment the precision changed, we normalize the
      // size
  ...
  /**
   * If {@code intVal} has a fractional part throws an exception, otherwise it counts the number of
   * bits of value and checks if it's out of the range of the primitive type. If the number fits in
   * the primitive type returns this number as {@code long}, otherwise throws an exception.
   *
   * @param bitLengthOfType number of bits of the type whose value will be calculated exactly
   * @return the exact value of the integer part of {@code BigDecimal} when is possible
   * @throws ArithmeticException when rounding is necessary or the number don't fit in the primitive
   *     type
   */

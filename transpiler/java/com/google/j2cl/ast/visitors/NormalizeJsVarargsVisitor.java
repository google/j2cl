 ...
 * body.
 */
public class NormalizeJsVarargsVisitor extends AbstractRewriter {
  ...
  public static void applyTo(CompilationUnit compilationUnit) {
    new NormalizeJsVarargsVisitor().normalizeJsVarargs(compilationUnit);
  }

  private void normalizeJsVarargs(CompilationUnit compilationUnit) {
    compilationUnit.accept(new NormalizeVarargsJsMethodsVisitor());
   ...
   */
  private static class NormalizeVarargsJsMethodsVisitor extends AbstractRewriter {

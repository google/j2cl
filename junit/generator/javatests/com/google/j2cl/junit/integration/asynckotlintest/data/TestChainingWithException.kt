...
class TestChainingWithException {
  @Test(timeout = 200L)
  fun testChainingWithException(): Thenable {
    return Thenable { _, onRejected ->
      Timer.schedule({ onRejected.execute(RuntimeException("Should fail with this message")) }, 0)
    }
  }
}

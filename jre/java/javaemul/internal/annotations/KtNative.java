...
public @interface KtNative {
  /**
   * Sets the custom name of the Kotlin type to use whenever transpiled Java code references the
   * annotated type.
   *
   * <p>The name must be fully-qualified, for top-level types but also for nested types. If the name
   * is not specified, the original name is used.
   */
   ...
   * and its sub-types.
   */
  String bridgeName() default "<auto>";

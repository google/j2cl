...
/**
 * Test examples are different combinations properties toggling in a 3 class hierarchy (child class,
 ...
 * - interfaceIsJsType
 *
 * Some combinations don't work yet in J2CL and are temporarily disabled. They are marked with a
 * TODO.
 *
 * Some combinations are not valid Java or result in duplicate output. These have been omitted.
 */
fun main(vararg unused: String) {
  ...
  Tester23.test()
  Tester24.test()
  // Tester113.test() // Illegal in Kotlin, ambiguous inherited method.
  // Tester114.test() // Illegal in Kotlin, ambiguous inherited method.
  Tester115.test()
  Tester116.test()
  // Tester117.test() // Illegal in Kotlin, ambiguous inherited method.
  // Tester118.test() // Illegal in Kotlin, ambiguous inherited method.
  Tester119.test()
  Tester120.test()

...
public class NullabilityInferenceProblem15 {
  ...
  public static void testWorkaround(SpacersTable<? extends SpacersCell<?>> table) {
    JsArray<? extends SpacersCell<?>> cells = getCellsInRow(table);
  }

  private static <T extends @Nullable SpacersCell<T>> JsArray<T> getCellsInRow(
      SpacersTable<T> table) {
    return table.getCellsInRow();
  }
}

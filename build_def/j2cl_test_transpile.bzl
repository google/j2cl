"""j2cl_test_transpile build macro

Takes Java source that contains JUnit tests, translates it into Closure style
JS and makes it available to be consumed in JavaScript tests (like jsunit).
 ...
 * J2CL java tests.
 *
 * @author generated by j2cl_test_transpile.bzl.
 */
...
def j2cl_test_transpile(base_name, test_class, **kwargs):

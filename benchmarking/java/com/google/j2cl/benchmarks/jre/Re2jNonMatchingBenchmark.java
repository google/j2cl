...
/**
 * Benchmark RE2/J matching performance when inputs are guaranteed to not match after 11 characters.
 */
public class Re2jNonMatchingBenchmark extends AbstractBenchmark {

...
public class ParameterizedTestInitializedByConstructor {
  ...
  public ParameterizedTestInitializedByConstructor(String input, int expected) {
    this.input = input + "abc";
    this.expected = expected * 2;
  }

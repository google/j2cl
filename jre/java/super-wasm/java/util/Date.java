...
public class Date implements Cloneable, Comparable<Date>, Serializable {
  ...
  public static long parse(String s) {
    if (s == null) { // Passing null always results in NaN.
      throw new IllegalArgumentException();
    }
    double parsed = NativeDate.parse(s.toJsString());
  ...
  private static class NativeDate {
    ...
    // CHECKSTYLE_OFF: Matching the spec.
    @JsMethod(name = "Date.UTC", namespace = JsPackage.GLOBAL)
    ...
    @JsMethod(name = "Date.create", namespace = JsPackage.GLOBAL)
    public static native WasmExtern create();

    private NativeDate(double millis) {
      instance = create(millis);
    }

    @JsMethod(name = "Date.create", namespace = JsPackage.GLOBAL)
    public static native WasmExtern create(double millis);

    public NativeDate(
        int year, int month, int dayOfMonth, int hours, int minutes, int seconds, int millis) {
      instance = create(year, month, dayOfMonth, hours, minutes, seconds, millis);
    }
    ...
    @JsMethod(name = "Date.getDate", namespace = JsPackage.GLOBAL)
    private static native int getDate(WasmExtern date);

    public int getDay() {
      return getDay(instance);
    }

    @JsMethod(name = "Date.getDay", namespace = JsPackage.GLOBAL)
    private static native int getDay(WasmExtern date);

    public int getFullYear() {
      return getFullYear(instance);
    }

    @JsMethod(name = "Date.getFullYear", namespace = JsPackage.GLOBAL)
    private static native int getFullYear(WasmExtern date);

    public int getHours() {
      return getHours(instance);
    }

    @JsMethod(name = "Date.getHours", namespace = JsPackage.GLOBAL)
    private static native int getHours(WasmExtern date);

    public int getMilliseconds() {
      return getMilliseconds(instance);
    }

    @JsMethod(name = "Date.getMilliseconds", namespace = JsPackage.GLOBAL)
    private static native int getMilliseconds(WasmExtern date);

    public int getMinutes() {
      return getMinutes(instance);
    }

    @JsMethod(name = "Date.getMinutes", namespace = JsPackage.GLOBAL)
    private static native int getMinutes(WasmExtern date);

    public int getMonth() {
      return getMonth(instance);
    }

    @JsMethod(name = "Date.getMonth", namespace = JsPackage.GLOBAL)
    private static native int getMonth(WasmExtern date);

    public int getSeconds() {
      return getSeconds(instance);
    }

    @JsMethod(name = "Date.getSeconds", namespace = JsPackage.GLOBAL)
    private static native int getSeconds(WasmExtern date);

    public double getTime() {
      return getTime(instance);
    }

    @JsMethod(name = "Date.getTime", namespace = JsPackage.GLOBAL)
    private static native double getTime(WasmExtern date);

    public int getTimezoneOffset() {
      return getTimezoneOffset(instance);
    }

    @JsMethod(name = "Date.getTimezoneOffset", namespace = JsPackage.GLOBAL)
    private static native int getTimezoneOffset(WasmExtern date);

    public int getUTCDate() {
      return getUTCDate(instance);
    }

    @JsMethod(name = "Date.getUTCDate", namespace = JsPackage.GLOBAL)
    private static native int getUTCDate(WasmExtern date);

    public int getUTCFullYear() {
      return getUTCFullYear(instance);
    }

    @JsMethod(name = "Date.getUTCFullYear", namespace = JsPackage.GLOBAL)
    private static native int getUTCFullYear(WasmExtern date);

    public int getUTCHours() {
      return getUTCHours(instance);
    }

    @JsMethod(name = "Date.getUTCHours", namespace = JsPackage.GLOBAL)
    private static native int getUTCHours(WasmExtern date);

    public int getUTCMinutes() {
      return getUTCMinutes(instance);
    }

    @JsMethod(name = "Date.getUTCMinutes", namespace = JsPackage.GLOBAL)
    private static native int getUTCMinutes(WasmExtern date);

    public int getUTCMonth() {
      return getUTCMonth(instance);
    }

    @JsMethod(name = "Date.getUTCMonth", namespace = JsPackage.GLOBAL)
    private static native int getUTCMonth(WasmExtern date);

    public int getUTCSeconds() {
      return getUTCSeconds(instance);
    }

    @JsMethod(name = "Date.getUTCSeconds", namespace = JsPackage.GLOBAL)
    private static native int getUTCSeconds(WasmExtern date);

    public void setDate(int dayOfMonth) {
      setDate(instance, dayOfMonth);
    }

    @JsMethod(name = "Date.setDate", namespace = JsPackage.GLOBAL)
    private static native void setDate(WasmExtern date, int dayOfMonth);

    public void setFullYear(int year) {
      setFullYear(instance, year);
    }

    @JsMethod(name = "Date.setFullYear", namespace = JsPackage.GLOBAL)
    private static native void setFullYear(WasmExtern date, int year);

    public void setFullYear(int year, int month, int day) {
      setFullYear(instance, year, month, day);
    }

    @JsMethod(name = "Date.setFullYear", namespace = JsPackage.GLOBAL)
    private static native void setFullYear(WasmExtern date, int year, int month, int day);

    public void setHours(int hours) {
      setHours(instance, hours);
    }

    @JsMethod(name = "Date.setHours", namespace = JsPackage.GLOBAL)
    private static native void setHours(WasmExtern date, int hours);

    public void setHours(int hours, int mins, int secs, int ms) {
      setHours(instance, hours, mins, secs, ms);
    }

    @JsMethod(name = "Date.setHours", namespace = JsPackage.GLOBAL)
    private static native void setHours(WasmExtern date, int hours, int mins, int secs, int ms);

    public void setMinutes(int minutes) {
      setMinutes(instance, minutes);
    }

    @JsMethod(name = "Date.setMinutes", namespace = JsPackage.GLOBAL)
    private static native void setMinutes(WasmExtern date, int minutes);

    public void setMonth(int month) {
      setMonth(instance, month);
    }

    @JsMethod(name = "Date.setMonth", namespace = JsPackage.GLOBAL)
    private static native void setMonth(WasmExtern date, int month);

    public void setSeconds(int seconds) {
      setSeconds(instance, seconds);
    }

    @JsMethod(name = "Date.setSeconds", namespace = JsPackage.GLOBAL)
    private static native void setSeconds(WasmExtern date, int seconds);

    public void setTime(double milliseconds) {
      setTime(instance, milliseconds);
    }

    @JsMethod(name = "Date.setTime", namespace = JsPackage.GLOBAL)
    private static native void setTime(WasmExtern date, double milliseconds);

    public String toLocaleString() {
      return String.fromJsString(toLocaleString(instance));
    }

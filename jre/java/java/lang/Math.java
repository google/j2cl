// TODO(dankurka): forked version from GWT, needs to be reverted
// after we can handle reference colliding.
/*
...
public final class Math {
  ...
  public static native double acos(double x) /*-{
    return window.Math.acos(x);
  }-*/;

  public static native double asin(double x) /*-{
    return window.Math.asin(x);
  }-*/;

  public static native double atan(double x) /*-{
    return window.Math.atan(x);
  }-*/;
  ...
  public static native double log(double x) /*-{
    return window.Math.log(x);
  }-*/;

  public static native double log10(double x) /*-{
    return window.Math.log(x) * window.Math.LOG10E;
  }-*/;
  ...
  public static native double sqrt(double x) /*-{
    return window.Math.sqrt(x);
  }-*/;

  public static native double tan(double x) /*-{
    return window.Math.tan(x);
  }-*/;

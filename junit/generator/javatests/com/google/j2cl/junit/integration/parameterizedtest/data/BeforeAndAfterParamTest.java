...
public class BeforeAndAfterParamTest {
  ...
  @BeforeParam
  public static void beforeParam1() {
    TestCaseLogger.log("beforeParam1");
  }

  @BeforeParam
  public static void beforeParam2() {
    TestCaseLogger.log("beforeParam2");
  }

  @AfterParam
  public static void afterParam1() {
    TestCaseLogger.log("afterParam1");
  }

  @AfterParam
  public static void afterParam2() {
    TestCaseLogger.log("afterParam2");
  }
  ...
  public BeforeAndAfterParamTest(String input1, String input2) {
    this.input1 = input1;
    this.input2 = input2;

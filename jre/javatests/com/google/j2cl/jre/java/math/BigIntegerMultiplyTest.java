...
public class BigIntegerMultiplyTest extends EmulTestBase {
  ...
  /** Multiply two numbers of the same length and different signs. The first is negative. */
  public void testCase2() {
    ...
    int bSign = 1;
    byte[] rBytes = {
      -11, -41, -101, 54, -97, -52, -77, -41, 44, -86, -106, -5, -29, 85, 116, 51, -101, -121, -90
    };
    BigInteger aNumber = new BigInteger(aSign, aBytes);
    BigInteger bNumber = new BigInteger(bSign, bBytes);
    BigInteger result = aNumber.multiply(bNumber);
  ...
  public void testCase3() {
    ...
    int bSign = 1;
    byte[] rBytes = {
      10, 40, 100, -55, 96, 51, 76, 40, -45, 85, 115, 44, -127, 115, -21, -62, -15, 85, 64, -87, -2,
      -36, -36, -106
    };
    BigInteger aNumber = new BigInteger(aSign, aBytes);
    BigInteger bNumber = new BigInteger(bSign, bBytes);
  ...
  /**
   * Multiply two numbers of different length and different signs. The first is positive. The first
   * is longer.
   */
  public void testCase5() {
    ...
    int bSign = -1;
    byte[] rBytes = {
      -11, -41, -101, 54, -97, -52, -77, -41, 44, -86, -116, -45, 126, -116, 20, 61, 14, -86, -65,
      86, 1, 35, 35, 106
    };
    BigInteger aNumber = new BigInteger(aSign, aBytes);
    BigInteger bNumber = new BigInteger(bSign, bBytes);
  ...
  /**
   * Multiply two numbers of different length and different signs. The first is positive. The second
   * is longer.
   */
  ...
  public void testPowNegativeNumToOddExp() {
    ...
    int exp = 5;
    byte[] rBytes = {
      -21, -94, -42, -15, -127, 113, -50, -88, 115, -35, 3, 59, -92, 111, -75, 103, -42, 41, 34,
      -114, 99, -32, 105, -59, 127, 45, 108, 74, -93, 105, 33, 12, -5, -20, 17, -21, -119, -127,
  ...
  public void testPowPositiveNum() {
    ...
    int exp = 5;
    byte[] rBytes = {
      20, 93, 41, 14, 126, -114, 49, 87, -116, 34, -4, -60, 91, -112, 74, -104, 41, -42, -35, 113,
      -100, 31, -106, 58, -128, -46, -109, -75, 92, -106, -34, -13, 4, 19, -18, 20, 118, 126, 114,

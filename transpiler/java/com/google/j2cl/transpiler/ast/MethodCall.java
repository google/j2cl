...
public class MethodCall extends Invocation {
  ...
  public static Builder builderFrom(MethodDescriptor methodDescriptor) {
    return builder().setTarget(methodDescriptor).setSourcePosition(SourcePosition.NONE);
  }

...
public class CompilationUnitBuilder extends AbstractCompilationUnitBuilder {
  ...
  private Expression convertMemberReference(JCMemberReference memberReference) {
    ...
    var typeArguments =
        convertTypeArguments(memberReference.getTypeArguments(), methodSymbol, methodType);
  ...
  private Expression convertNewClass(JCNewClass expression) {
    ...
    var typeArguments =
        convertTypeArguments(expression.getTypeArguments(), constructorElement, methodType);
  ...
  private Expression convertMethodInvocation(JCMethodInvocation methodInvocation) {
    ...
    var typeArguments =
        convertTypeArguments(methodInvocation.getTypeArguments(), methodSymbol, methodType);

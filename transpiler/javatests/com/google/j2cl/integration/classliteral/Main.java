 ...
 */
package com.google.j2cl.integration.classliteral;
...
public class Main {
  ...
  private static void testClass() {
    ...
    assertEquals("com.google.j2cl.integration.classliteral.Main", Main.class.getName());
    assertEquals("com.google.j2cl.integration.classliteral.Main$Foo", Foo.class.getName());

    assertEquals("com.google.j2cl.integration.classliteral.Main", Main.class.getCanonicalName());
    // J2CL doesn't follow JLS here:
    assertEquals("com.google.j2cl.integration.classliteral.Main$Foo", Foo.class.getCanonicalName());

    assertEquals("Main", Main.class.getSimpleName());
    assertEquals("Foo", Foo.class.getSimpleName());

    assertEquals("class com.google.j2cl.integration.classliteral.Main", Main.class.toString());
    assertEquals("class com.google.j2cl.integration.classliteral.Main$Foo", Foo.class.toString());
  ...
  private static void testInterface() {
    ...
    assertEquals("com.google.j2cl.integration.classliteral.Main$IFoo", IFoo.class.getName());
    // J2CL doesn't follow JLS here:
    assertEquals(
        "com.google.j2cl.integration.classliteral.Main$IFoo", IFoo.class.getCanonicalName());
    assertEquals("IFoo", IFoo.class.getSimpleName());
    // J2CL doesn't follow JLS here:
    assertEquals(
        "interface com.google.j2cl.integration.classliteral.Main$IFoo", IFoo.class.toString());
  ...
  private static void testEnum() {
    ...
    assertEquals("com.google.j2cl.integration.classliteral.Main$Bar", o.getClass().getName());
    // J2CL doesn't follow JLS here:
    assertEquals(
        "com.google.j2cl.integration.classliteral.Main$Bar", o.getClass().getCanonicalName());
    assertEquals("Bar", o.getClass().getSimpleName());
    assertEquals(
        "class com.google.j2cl.integration.classliteral.Main$Bar", o.getClass().toString());
  ...
  private static void testEnumSubclass() {
    ...
    assertEquals("com.google.j2cl.integration.classliteral.Main$Bar$1", o.getClass().getName());
    assertEquals(
        "class com.google.j2cl.integration.classliteral.Main$Bar$1", o.getClass().toString());
  ...
  private static void testJsEnum() {
    ...
    assertEquals("com.google.j2cl.integration.classliteral.Main$MyJsEnum", o.getClass().getName());
    // J2CL doesn't follow JLS here:
    assertEquals(
        "com.google.j2cl.integration.classliteral.Main$MyJsEnum", o.getClass().getCanonicalName());
    assertEquals("MyJsEnum", o.getClass().getSimpleName());
    assertEquals(
        "class com.google.j2cl.integration.classliteral.Main$MyJsEnum", o.getClass().toString());
  ...
  private static void testExtendsNative() {
    assertEquals(
        "com.google.j2cl.integration.classliteral.Main$TypeExtendsNativeClass",

...
public final class MathContext implements Serializable {
  ...
  /**
   * A {@code MathContext} which corresponds to the IEEE 754r quadruple decimal precision format: 34
   * digit precision and {@link RoundingMode#HALF_EVEN} rounding.
   */
  public static final MathContext DECIMAL128 = new MathContext(34, RoundingMode.HALF_EVEN);

  /**
   * A {@code MathContext} which corresponds to the IEEE 754r single decimal precision format: 7
   * digit precision and {@link RoundingMode#HALF_EVEN} rounding.
   */
  public static final MathContext DECIMAL32 = new MathContext(7, RoundingMode.HALF_EVEN);

  /**
   * A {@code MathContext} which corresponds to the IEEE 754r double decimal precision format: 16
   * digit precision and {@link RoundingMode#HALF_EVEN} rounding.
   */
  ...
  /**
   * Constructs a new {@code MathContext} with the specified precision and with the rounding mode
   * {@link RoundingMode#HALF_UP HALF_UP}. If the precision passed is zero, then this implies that
   * the computations have to be performed exact, the rounding mode in this case is irrelevant.
   *
  ...
  /**
   * Constructs a new {@code MathContext} with the specified precision and with the specified
   * rounding mode. If the precision passed is zero, then this implies that the computations have to
   ...
   *
   * @param val a string describing the precision and rounding mode for the new {@code MathContext}.
  ...
  /**
   * Returns the precision. The precision is the number of digits used for an operation. Results are
   * rounded to this precision. The precision is guaranteed to be non negative. If the precision is
   * zero, then the computations have to be performed exact, results are not rounded in this case.
   *
   ...
   *
   * <p>The rounding mode is one of {@link RoundingMode#UP}, {@link RoundingMode#DOWN}, {@link
   * RoundingMode#CEILING}, {@link RoundingMode#FLOOR}, {@link RoundingMode#HALF_UP}, {@link
  ...
  /**
   * Returns the string representation for this {@code MathContext} instance. The string has the
   * form {@code "precision=<precision> roundingMode=<roundingMode>" * } where {@code <precision>}
   * is an integer describing the number of digits used for operations and {@code <roundingMode>} is
   * the string representation of the rounding mode.
   *

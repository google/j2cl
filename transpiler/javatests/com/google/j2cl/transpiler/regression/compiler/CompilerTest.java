...
public class CompilerTest {
  ...
  public void testClassLiterals() {
    ...
    assertEquals(
        "class com.google.j2cl.transpiler.regression.compiler.CompilerTest",
        CompilerTest.class.toString());
    assertEquals(
        "class com.google.j2cl.transpiler.regression.compiler.CompilerTest$UninstantiableType",
    ...
    assertEquals(
        ...
        CompilerTest[].class.toString());
    assertEquals(
        "class [Lcom.google.j2cl.transpiler.regression.compiler.CompilerTest$UninstantiableType;",
        UninstantiableType[].class.toString());
    assertEquals(
        "class [Lcom.google.j2cl.transpiler.regression.compiler.CompilerTest$Fruit;",
        Fruit[].class.toString());
  }

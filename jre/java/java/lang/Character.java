...
public final class Character implements Comparable<Character>, Serializable {
  ...
  public static native boolean isDigit(char c) /*-{
    return (null != window.String.fromCharCode(c).match(/\d/));
  }-*/;
  ...
  public static native boolean isLetter(char c) /*-{
    return (null != window.String.fromCharCode(c).match(/[A-Z]/i));
  }-*/;
  ...
  public static native boolean isLetterOrDigit(char c) /*-{
    return (null != window.String.fromCharCode(c).match(/[A-Z\d]/i));
  }-*/;
  ...
  public static native boolean isWhitespace(int codePoint) /*-{
    return (null !== window.String.fromCharCode(codePoint).match(
      /[\t-\r \u1680\u180E\u2000-\u2006\u2008-\u200A\u2028\u2029\u205F\u3000\uFEFF]|[\x1C-\x1F]/
    ));
  }-*/;
  ...
  public static native char toLowerCase(char c) /*-{
    return window.String.fromCharCode(c).toLowerCase().charCodeAt(0);
  }-*/;
  ...
  public static native char toUpperCase(char c) /*-{
    return window.String.fromCharCode(c).toUpperCase().charCodeAt(0);
  }-*/;
